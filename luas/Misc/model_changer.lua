local t_player_models = {
    ...
    ["leet"] = "models/player/custom_player/legacy/tm_leet_variante.mdl",     
    ["artic"] = "models/player/custom_player/eminem/css/t_arctic.mdl", 
    ["anime_girl"] = "models/player/custom_player/kolka/anime_girl/anime_girl.mdl", 
    ["Fox miku"] = "models/player/custom_player/bbs_93x_net_2015/fox_miku/update_2015_11_29/fox_miku_hotfix.mdl",
    ["Felix"] = "models/player/custom_player/owston/rezero/felixtrap3.mdl",
    ["Hibiki"] = "models/player/custom_player/toppiofficial/kancolle/hibiki_fix.mdl",    
    ["selena1"] = "models/player/custom_player/toppiofficial/pgr/selena_fix1.mdl", 
...
label1 = ui.new_label('skins', 'model options', '---------------------------------------')
local model_check = ui.new_multiselect('skins', 'model options', 'Custom Agent changer', {"CT", "T"})
local localplayer_model_ct = ui.new_combobox("skins", "model options", "CT Model", model_names_ct)
local localplayer_model_t = ui.new_combobox("skins", "model options", "T Model", model_names)
label2 = ui.new_label('skins', 'model options', '---------------------------------------')
