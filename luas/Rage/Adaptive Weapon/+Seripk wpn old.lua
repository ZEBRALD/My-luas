...
local master_switch = ui_new_checkbox("LUA", "A", "Enable Seripk wpn")
...
for i=1, #config_names do
    rage[i] = {
        ...
        target_selection = ui_new_combobox("LUA", "A", "[" .. config_names[i] .. "] Target selection", {"Cycle", "Cycle (2x)", "Near crosshair", "Highest damage", "Best hit chance"}),
...
local calculate_multi_point = function(e)
	...
	local double_check, double_key = ui.reference("RAGE", "Aimbot", "Double tap")
