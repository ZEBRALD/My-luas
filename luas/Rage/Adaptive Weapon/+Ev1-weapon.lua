...
local weapon = {
    ...
    main_switch = ui.new_checkbox("Rage", "Aimbot", "Adaptive weapon config v"..version..''),
    ...
    draw_panel = ui.new_checkbox("Rage", "Aimbot", "Weapon hud"),
    x = ui.new_slider("Rage", "Aimbot", "X", 0, screen_size_x, screen_size_x/4, true, "", 1),
    y = ui.new_slider("Rage", "Aimbot", "Y", 0, screen_size_y, screen_size_y/2, true, "", 1),
...
for i,o in ipairs(weapon_name) do 
    weapon.cfg[i] = {
        ...
        accuarcy_boost = ui.new_combobox("Rage", "Other", "[" .. o .. "] Accuracy boost",{'Low','Medium','High'}),
...
local function indicator()
    ...
    if ui.get(weapon.ovr_dmg) and includes(ui.get(weapon.available),'Min DMG') then
        renderer.indicator(220,220,220,includes(ui.get(weapon.cfg[id].damage_mode),'Override 1') and 255 or 150, 'OVR DAMAGE 1')
    end
