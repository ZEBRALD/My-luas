...
local active = ui.new_checkbox('CONFIG', 'Presets', 'Hotkey list Ind')
...
create_item('RAGE', 'Aimbot', 'Quick stop', 2)
create_item('RAGE', 'Other', 'Quick peek assist', 2)
create_item('RAGE', 'Aimbot', 'Force body aim', 1)
create_item('RAGE', 'Other', 'Duck peek assist', 1)
create_item('RAGE', 'Aimbot', 'Double tap', 2)
