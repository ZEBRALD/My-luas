...
local ms_palette, ms_color, ms_color_ext = 
	...
	ui_new_color_picker('CONFIG', 'Presets', 'Solus Global color 2', 42, 165, 229, 85)
...
local ms_classes = {
	watermark = function()
		...
		local g_paint_handler = function()
			...
			note.get(function(id)
				...
				local suffix = "gamesense"
				local rx, gx, bx, ax = ui_get(ms_color_ext)
				...
				if ui_get(ms_palette) == menu_palette[1] then
					renderer_gradient(x, y, (w/2)+2, 2, r, g, b, 200, rx, gx, bx, 255, true)
					renderer_gradient(x + w/2+1, y, w-w/2, 2, rx, gx, bx, 255, r, g, b, 200, true)
					renderer_circle_outline(x, y+5, r, g, b, 200, 5, 180, 0.25, 2)
					renderer_circle_outline(x + w, y+5, r, g, b, 200, 5, 270, 0.25, 2)
					renderer_gradient(x-5, y+5, 2, 12, r, g, b, 155, r, g, b, 0, false)
					renderer_gradient(x + w+3, y+5, 2, 12, r, g, b, 155, r, g, b, 0, false)
				else
					renderer_gradient(x, y, (w/2)+2, 2, g, b, r, 200, r, g, b, 255, true)
					renderer_gradient(x + w/2+1, y, w-w/2+1, 2, r, g, b, 255, b, r, g, 200, true)
					renderer_circle_outline(x, y+5, g, b, r, 200, 5, 180, 0.25, 2)
					renderer_circle_outline(x + w, y+5, b, r, g, 200, 5, 270, 0.25, 2)
					renderer_gradient(x-5, y+5, 2, 12, g, b, r, 155, g, b, r, 0, false)
					renderer_gradient(x + w+3, y+5, 2, 12, b, r, g, 155, b, r, g, 0, false)
				end
	...
	spectators = function()
		...
		local g_paint_handler = function()
			...
			local text = gradient_text(r, g, b, m_alpha*255, ui_get(ms_palette) == menu_palette[1] and rx or b, ui_get(ms_palette) == menu_palette[1] and gx or r, ui_get(ms_palette) == menu_palette[1] and bx or g, m_alpha*255, "spectators")

			if ui_get(ms_palette) == menu_palette[1] then
				renderer_gradient(x, y, (w/2)+2, 2, r, g, b, m_alpha*200, rx, gx, bx, m_alpha*255, true)
				renderer_gradient(x + w/2+1, y, w-w/2, 2, rx, gx, bx, m_alpha*255, r, g, b, m_alpha*200, true)
				renderer_circle_outline(x, y+5, r, g, b, m_alpha*200, 5, 180, 0.25, 2)
				renderer_circle_outline(x + w, y+5, r, g, b, m_alpha*200, 5, 270, 0.25, 2)
				renderer_gradient(x-5, y+5, 2, 12, r, g, b, m_alpha*155, r, g, b, 0, false)
				renderer_gradient(x + w+3, y+5, 2, 12, r, g, b, m_alpha*155, r, g, b, 0, false)
			else
				renderer_gradient(x, y, (w/2)+2, 2, g, b, r, m_alpha*200, r, g, b, m_alpha*255, true)
				renderer_gradient(x + w/2+1, y, w-w/2+1, 2, r, g, b, m_alpha*255, b, r, g, m_alpha*200, true)
				renderer_circle_outline(x, y+5, g, b, r, m_alpha*200, 5, 180, 0.25, 2)
				renderer_circle_outline(x + w, y+5, b, r, g, m_alpha*200, 5, 270, 0.25, 2)
				renderer_gradient(x-5, y+5, 2, 12, g, b, r, m_alpha*155, g, b, r, m_alpha*0, false)
				renderer_gradient(x + w+3, y+5, 2, 12, b, r, g, m_alpha*155, b, r, g, m_alpha*0, false)
			end

		
			renderer_text(x - renderer_measure_text(nil, text) / 2 + w/2, y + 4, 255, 255, 255, m_alpha*255, '-', 0, string.upper(text))
	...
	keybinds = function()
		...
		local hotkey_modes = { 'use', 'use', 'off' }
		...
		local g_paint_handler = function()
			...
			local text = gradient_text(r, g, b, m_alpha*255, ui_get(ms_palette) == menu_palette[1] and rx or b, ui_get(ms_palette) == menu_palette[1] and gx or r, ui_get(ms_palette) == menu_palette[1] and bx or g, m_alpha*255, "keybinds")
			...
			if ui_get(ms_palette) == menu_palette[1] then
				...
				renderer_circle_outline(x, y+5, r, g, b, m_alpha*200, 5, 180, 0.25, 2)
				renderer_circle_outline(x + w, y+5, r, g, b, m_alpha*200, 5, 270, 0.25, 2)
				renderer_gradient(x-5, y+5, 2, 12, r, g, b, m_alpha*155, r, g, b, m_alpha*0, false)
				renderer_gradient(x + w+3, y+5, 2, 12, r, g, b, m_alpha*155, r, g, b, m_alpha*0, false)
	...
	antiaim = function()
        ...
        local g_paint_handler = function()
            ...
            note.get(function(id)
				...
				renderer_gradient(x, y, w/2, 2, r, g, b, 155, r, g, b, 255, true)
                renderer_gradient(x + w/2, y, w - w/2 + 1, 2, r, g, b, 255, r, g, b, 155, true)

				renderer_circle_outline(x, y+5, r, g, b, 155, 5, 180, 0.25, 2)
				renderer_circle_outline(x + w, y+5, r, g, b, 155, 5, 270, 0.25, 2)

				renderer_gradient(x-5, y+5, 2, 5, r, g, b, 155, r, g, b, 0, false)
				renderer_gradient(x + w + 3, y+5, 2, 5, r, g, b, 155, r, g, b, 0, false)
                ...
                renderer_gradient(x - w - 16, y, 2, h / 2, dec[1], dec[2], dec[3], 0, r, g, b, 255, false)
                renderer_gradient(x - w - 16, y + h/2, 2, h / 2, r, g, b, 255, dec[1], dec[2], dec[3], 0, false)
        
                -- BACKGROUND GRADIENT

                renderer_text(x - w - 10, y + 2, 255, 255, 255, 255, '', 0, text)
        
                if lower_body.updating and timer >= 0 then
                    renderer_circle_outline(x - w - 4, y + 8.5, 89, 119, 239, 255, 5, 0, timer, 2)
                end
            end)
        end
    ...
    ilstate = function()
		...
		local g_paint_handler = function()
			...
			note.get(function(id)
				...
				renderer_gradient(x, y, w/2, 2, interp[1], interp[2], interp[3], 155, interp[1], interp[2], interp[3], 255, true)
                renderer_gradient(x + w/2, y, w - w/2 + 1, 2, interp[1], interp[2], interp[3], 255, interp[1], interp[2], interp[3], 155, true)

				renderer_circle_outline(x, y+5, interp[1], interp[2], interp[3], 155, 5, 180, 0.25, 2)
				renderer_circle_outline(x + w, y+5, interp[1], interp[2], interp[3], 155, 5, 270, 0.25, 2)

				renderer_gradient(x-5, y+5, 2, 5, interp[1], interp[2], interp[3], 155, interp[1], interp[2], interp[3], 0, false)
				renderer_gradient(x + w + 3, y+5, 2, 5, interp[1], interp[2], interp[3], 155, interp[1], interp[2], interp[3], 0, false)

                renderer_gradient(x, y+h, (w/2), 1, interp[1], interp[2], interp[3], 0, interp[1], interp[2], interp[3], 255, true)
                renderer_gradient(x + w/2, y+h, w-w/2, 1, interp[1], interp[2], interp[3], 255,interp[1], interp[2], interp[3], 0, true)
	            ...
	            renderer_gradient(x - w - 16, y, 2, h / 2, r, g, b, 0, r, g, b, 255, false)
                renderer_gradient(x - w - 16, y + h/2, 2, h / 2, r, g, b, 255, r, g, b, 0, false)
	...
	weapons = function ()
		...
		local g_paint_handler = function()
			local x, y = dragging:get()
			local r, g, b, a = get_bar_color()
			local rx, gx, bx, ax = ui.get(ms_color_ext)
			local text = gradient_text(r, g, b, 255, rx, gx, bx, 255,"weapon  status")
			local realtime = globals.realtime() % 2
			local alpha = math.floor(math.sin(realtime * 3) * (255/2-1) + 255/2) or 255
			local height_offset = 23
			...
			local w, h =  renderer_measure_text(nil, text) + math.max(weapon_w / 2, timeToShoot * 70), 50
			if ui.get(ms_weapons) then
				...
				renderer.text(x - renderer_measure_text(nil, text) / 2 + w/2+5, y + 4, 255, 255, 255, 255, "-", 0, string.upper(text))
				weapon_icon:draw(x + 5 , y + 20, weapon_w / 2, weapon_h / 2, 255, 255, 255, 255)
				renderer.text(x + 15 + weapon_w / 2, y + 20, 255, 255, 255, 255, "-", 0, string.upper("HIT  CHANCE:"..ui.get(ref_htc)))
				renderer.text(x + 15 + weapon_w / 2, y + 30, 255, 255, 255, 255, "-", 0, string.upper("MIN  DAMAGE:"..ui.get(ref_md)))
				renderer.text(x, y + 40, 255, 255, 255, timeToShoot>0 and 255 or 0, "-", 0, string.upper("weapon  fired:"))
				renderer_gradient(x + renderer_measure_text(nil, string.upper("weapon  fired:")) - 15, y + 45, timeToShoot * 70, 2, 255, 255, 255, 255, 25, 25, 25, 75, true)
				dragging:drag(w, 13 )
			end
		end
