...
local damage_indicator  = ui_new_checkbox("VISUALS", "Effects", "Damage indicator")
local damage_color      = ui_new_color_picker("VISUALS", "Effects", "Damage color", 255, 255, 255, 255)
